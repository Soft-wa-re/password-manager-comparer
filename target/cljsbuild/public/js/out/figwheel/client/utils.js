...
return (new CustomEvent(event_name,(function (){var obj36814 = ({"detail":data});
return obj36814;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__5041__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(and__5041__auto__){
var and__5041__auto____$1 = figwheel.client.utils.goog$module$goog$object.get.call(null,window,"CustomEvent");
...
var f = (function (){var pred__36821 = cljs.core._EQ_;
var expr__36822 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36821.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36822))){
return (function (p1__36815_SHARP_){
return console.warn(p1__36815_SHARP_);
});
} else {
if(cljs.core.truth_(pred__36821.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36822))){
return (function (p1__36816_SHARP_){
return console.debug(p1__36816_SHARP_);
});
} else {
if(cljs.core.truth_(pred__36821.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36822))){
return (function (p1__36817_SHARP_){
return console.error(p1__36817_SHARP_);
});
} else {
return (function (p1__36818_SHARP_){
return console.log(p1__36818_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36825){
var map__36826 = p__36825;
var map__36826__$1 = cljs.core.__destructure_map.call(null,map__36826);
var opts = map__36826__$1;
var eval_fn = cljs.core.get.call(null,map__36826__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__36827_SHARP_){
return new_def.callback(p1__36827_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__36828){
var vec__36829 = p__36828;
var ky = cljs.core.nth.call(null,vec__36829,(0),null);
...
if(cljs.core.truth_((function (){var and__5041__auto__ = (((typeof localStorage !== 'undefined')) && ((!((figwheel.client.utils.goog$module$goog$object.get.call(null,localStorage,"getItem") == null)))));
if(and__5041__auto__){
...
//# sourceMappingURL=utils.js.map?rel=1672362824943
