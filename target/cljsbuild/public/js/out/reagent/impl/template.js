...
var G__35720 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__35720,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__35721__delegate = function (args){
...
while (G__35722__i < G__35722__a.length) {G__35722__a[G__35722__i] = arguments[G__35722__i + 0]; ++G__35722__i;}
  args = new cljs.core.IndexedSeq(G__35722__a,0,null);
} 
return G__35721__delegate.call(this,args);};
G__35721.cljs$lang$maxFixedArity = 0;
G__35721.cljs$lang$applyTo = (function (arglist__35723){
var args = cljs.core.seq(arglist__35723);
return G__35721__delegate(args);
});
...
var G__35724 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__35724,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__35728 = props;
var G__35728__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__35728,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35728);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__35728__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__35729 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__35729,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__35729;
}
})(),id_class);
...
var G__35730 = (cljs.core.count.call(null,argv) - first_child);
switch (G__35730) {
case (0):
...
var vec__35732 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__35732,(0),null);
var id = cljs.core.nth.call(null,vec__35732,(1),null);
var className = cljs.core.nth.call(null,vec__35732,(2),null);
...
var temp__5808__auto___35735 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___35735 == null)){
} else {
var key_35736 = temp__5808__auto___35735;
(jsprops.key = key_35736);
}
...
var temp__5808__auto___35737 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___35737 == null)){
} else {
var key_35738 = temp__5808__auto___35737;
(jsprops.key = key_35738);
}
...
var temp__5808__auto___35739 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___35739 == null)){
} else {
var key_35740 = temp__5808__auto___35739;
(jsprops.key = key_35740);
}
...
var temp__5808__auto___35741 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___35741 == null)){
} else {
var key_35742 = temp__5808__auto___35741;
(jsprops.key = key_35742);
}
...
var temp__5808__auto___35743 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___35743 == null)){
} else {
var key_35744 = temp__5808__auto___35743;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__35745_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__35745_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35746 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__35746,(0),null);
var derefed = cljs.core.nth.call(null,vec__35746,(1),null);
...
break;
default:
var G__35751 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__35752 = compiler;
v = G__35751;
compiler = G__35752;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template35756 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template35756 = (function (opts,id,fn_to_element,parse_fn,meta35757){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template35756.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35758,meta35757__$1){
var self__ = this;
var _35758__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35756(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta35757__$1));
}));

(reagent.impl.template.t_reagent$impl$template35756.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35758){
var self__ = this;
var _35758__$1 = this;
return self__.meta35757;
}));

(reagent.impl.template.t_reagent$impl$template35756.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35756.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35756.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template35756.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35756.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35756.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta35757","meta35757",1493370852,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35756.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35756.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35756");

(reagent.impl.template.t_reagent$impl$template35756.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template35756");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35756.
 */
reagent.impl.template.__GT_t_reagent$impl$template35756 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template35756(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35757){
return (new reagent.impl.template.t_reagent$impl$template35756(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35757));
});

}

return (new reagent.impl.template.t_reagent$impl$template35756(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1672362822453
