...
var map__36310 = top_item;
var map__36310__$1 = cljs.core.__destructure_map.call(null,map__36310);
var file = cljs.core.get.call(null,map__36310__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__36310__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__36310__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e36309){var _e = e36309;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___36311 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___36311)){
var seen_errors_36312 = temp__5802__auto___36311;
if(cljs.core.truth_(seen_errors_36312.has(self))){
} else {
seen_errors_36312.add(self);

var temp__5804__auto___36313 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___36313)){
var sense_36314 = temp__5804__auto___36313;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_36314)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1672362823336
