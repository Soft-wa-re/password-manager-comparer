...
var o30017 = temp__5802__auto__;
var temp__5802__auto____$1 = (o30017["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o30018 = temp__5802__auto____$1;
return (o30018["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29375__auto__ = f;
return (o__29375__auto__["toString"]).call(o__29375__auto__);
} else {
return "";
}
}catch (e30019){var _ = e30019;
return "";
}});
...
try{var o__29375__auto___30021 = t;
(o__29375__auto___30021["cljs$lang$ctorPrWriter"]).call(o__29375__auto___30021,t,writer);
}catch (e30020){var __30022 = e30020;
}
...
var char_code = (function (){var o__29375__auto__ = (new String(char$));
return (o__29375__auto__["charCodeAt"]).call(o__29375__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29375__auto__ = String;
return (o__29375__auto__["fromCharCode"]).call(o__29375__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30023 = num_code;
switch (G__30023) {
case (1):
return (185);
...
var o__29375__auto__ = String;
return (o__29375__auto__["fromCharCode"]).call(o__29375__auto__,superscript_code);
});
/**
...
}catch (e30025){var _e__29382__auto__ = e30025;
return false;
}})())){
...
var vec__30026 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30026,(0),null);
...
var len__5766__auto___30035 = arguments.length;
var i__5767__auto___30036 = (0);
while(true){
if((i__5767__auto___30036 < len__5766__auto___30035)){
args__5772__auto__.push((arguments[i__5767__auto___30036]));

var G__30037 = (i__5767__auto___30036 + (1));
i__5767__auto___30036 = G__30037;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30031){
var vec__30032 = p__30031;
var ns_detector = cljs.core.nth.call(null,vec__30032,(0),null);
...
var G__30038 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30039 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30038;
remaining_tokens = G__30039;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30029){
var G__30030 = cljs.core.first.call(null,seq30029);
var seq30029__$1 = cljs.core.next.call(null,seq30029);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30030,seq30029__$1);
}));
...
var vec__30043 = cljs.core.split_with.call(null,(function (p1__30042_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30042_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30043,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30043,(1),null);
...
var vec__30049 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30049,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30049,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30052 = cljs.core.rest.call(null,remaining_tokens);
var G__30053 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30052;
name_tokens = G__30053;
continue;
} else {
...
var vec__30056 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30056,(0),null);
var arity = cljs.core.nth.call(null,vec__30056,(1),null);
var vec__30059 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30059,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30059,(1),null);
var vec__30062 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30062,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30062,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30062,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30062,(3),null);
...
var vec__30068 = result;
var munged_ns = cljs.core.nth.call(null,vec__30068,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30068,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30068,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30068,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30068,(4),null);
var arity = cljs.core.nth.call(null,vec__30068,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__30072 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__30072,(0),null);
var args = cljs.core.nth.call(null,vec__30072,(1),null);
var vec__30075 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30075,(0),null);
var name = cljs.core.nth.call(null,vec__30075,(1),null);
...
var G__30078 = (arity + (1));
var G__30079 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30080){
var vec__30081 = p__30080;
var arity = cljs.core.nth.call(null,vec__30081,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30081,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30084_SHARP_){
return cljs.core.get.call(null,arities,p1__30084_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__30085_SHARP_){
return cljs.core.drop.call(null,(2),p1__30085_SHARP_);
}),sorted_infos);
...
var args__5772__auto__ = [];
var len__5766__auto___30092 = arguments.length;
var i__5767__auto___30093 = (0);
while(true){
if((i__5767__auto___30093 < len__5766__auto___30092)){
args__5772__auto__.push((arguments[i__5767__auto___30093]));

var G__30094 = (i__5767__auto___30093 + (1));
i__5767__auto___30093 = G__30094;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30088){
var vec__30089 = p__30088;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30089,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30086){
var G__30087 = cljs.core.first.call(null,seq30086);
var seq30086__$1 = cljs.core.next.call(null,seq30086);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30087,seq30086__$1);
}));
...
var map__30097 = options;
var map__30097__$1 = cljs.core.__destructure_map.call(null,map__30097);
var include_ns_QMARK_ = cljs.core.get.call(null,map__30097__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30097__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30097__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30097__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30098 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30098,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30098,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30098,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30098,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30098,(4),null);
var arity = cljs.core.nth.call(null,vec__30098,(5),null);
...
var o__29375__auto__ = f;
return (o__29375__auto__["getBasis"]).call(o__29375__auto__);
});
/**
...
}catch (e30101){var _e__29382__auto__ = e30101;
...
var G__30102 = (obj[cljs.core.first.call(null,path)]);
var G__30103 = cljs.core.rest.call(null,path);
obj = G__30102;
path = G__30103;
continue;
} else {
...
var _STAR_ = (function (accum,p__30104){
var vec__30105 = p__30104;
var bit = cljs.core.nth.call(null,vec__30105,(0),null);
var protocol = cljs.core.nth.call(null,vec__30105,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30108){
var vec__30109 = p__30108;
var ns = cljs.core.nth.call(null,vec__30109,(0),null);
var name = cljs.core.nth.call(null,vec__30109,(1),null);
var selector = cljs.core.nth.call(null,vec__30109,(2),null);
...
var post_process = (function (p__30113){
var vec__30114 = p__30113;
var munged_name = cljs.core.nth.call(null,vec__30114,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30114,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__30112_SHARP_){
return (obj[cljs.core.first.call(null,p1__30112_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1672362816951
